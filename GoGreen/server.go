...
func main() {
	...
	// user
	router.HandleFunc("/api/v1/user/{username}", handler.ListUser).Methods("GET")
	...
	router.HandleFunc("/editUser", user.EditUser)

	// Admin
	router.HandleFunc("/admin/users", user.UserAdminPage).Methods("GET")
	router.HandleFunc("/addUser", user.AddUser).Methods("POST")
	router.HandleFunc("/editUser", user.EditAdminUser)
	router.HandleFunc("/deleteUser", user.DeleteUser)
	// router.HandleFunc("/adminUser", user.UserPage).Methods("GET")
	// router.HandleFunc("/adminUser", user.UserPage).Methods("GET")
	// router.HandleFunc("/admin/delete", user.UserPage).Methods("DELETE")
